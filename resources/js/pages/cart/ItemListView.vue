        ...
        <template slot="no-body">
            <div class="vx-row item-details no-gutter">
                ...
                <div class="vx-col sm:w-1/4 w-full item-img-container bg-white flex items-center justify-center cursor-pointer" @click="navigate_to_detail_view">
                    <img :src="item.image_url" :alt="item.title" class="grid-view-img p-4">
                </div>
                ...
                <div class="vx-col sm:w-1/2">
                    <div class="p-4 pt-6">
                        <slot name="item-meta">
                            <h6 class="item-name font-semibold mb-1 hover:text-primary cursor-pointer" @click="navigate_to_detail_view">{{ item.title }}</h6>
