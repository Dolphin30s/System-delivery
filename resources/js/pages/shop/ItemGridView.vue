...
<template>
    <!-- <div class="item-grid-view vx-row match-height">
        <div class="vx-col" :class="gridColumnWidth" v-for="item in items" :key="item.id"> -->
    <vx-card class="grid-view-item mb-base overflow-hidden">
        <template slot="no-body">
            ...
            <div class="item-img-container bg-white h-64 flex items-center justify-center mb-4 cursor-pointer" @click="navigate_to_detail_view">
                <img :src="item.image_url" :alt="item.title" class="grid-view-img px-4">
            </div>
            <div class="item-details px-4">
                ...
                <!-- TITLE & DESCRIPTION -->
                <div class="my-4">
                    <h6 class="truncate font-semibold mb-1 hover:text-primary cursor-pointer" @click="navigate_to_detail_view">{{ item.title }}</h6>
