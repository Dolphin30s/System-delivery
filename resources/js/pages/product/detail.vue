            ...
            <template slot="no-body">
                            ...
                            <div class="vx-col md:w-2/5 w-full flex items-center justify-center">
                                <div class="product-img-container w-3/5 mx-auto mb-10 md:mb-0">
                                    <img
                                        ...
                                        :alt="item_data.name" class="responsive">
                            ...
                            <div class="vx-col md:w-3/5 w-full">
                                ...
                                <p class="flex items-center flex-wrap">
                                    ...
                                    <span
                                        ...
                                        :show-rating="false" :rating="item_data.rating" :star-size="20"
                                        read-only/></span>
                                    ...
                                    <div class="vx-col w-full">
                                        ...
                                        <div class="flex flex-wrap items-center mt-2">
                                            <div
                                                ...
                                                <div class="h-6 w-6 rounded-full absolute"
                                                     :style="itemColor({color: color, style: ['backgroundColor']})"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="related-products text-center px-6">
                    ...
                    <swiper :options="swiperOption" :dir="$vs.rtl ? 'rtl' : 'ltr'" :key="$vs.rtl"
                        ...
                        <swiper-slide v-for="item in related_items" :key="item.id"
                            ...
                            <!-- Item Meta -->
                            <div class="item-meta">
                                <star-rating :show-rating="false" :rating="item.rating" :star-size="14"
                                             class="justify-center" read-only/>
...
export default {
    ...
    methods: {
        ...
        fetch_item_details(id) {
            this.$store.dispatch('productList/fetchItem', {id})
                .then((content) => {
    ...
    created() {
        this.fetch_item_details(this.$route.query.id)
    }
}
</script>
...
@import "@assets/sass/vuexy/_variables.scss";
