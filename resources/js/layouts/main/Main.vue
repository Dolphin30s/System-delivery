...
<template>
    <div class="layout--main" :class="[layoutTypeClass, navbarClasses, footerClasses, {'no-scroll': isAppPage}]">
        ...
        <div id="content-area" :class="[contentAreaClass, {'show-overlay': bodyOverlay}, 'mx-auto']">
...
import {adminMenus, customerMenus, delivererMenus} from "../../menu";
...
export default {
    ...
    computed: {
        ...
        navMenuItems(){
            const user_role = Vue.auth.user().role;
            switch (user_role){
                case USER_ROLE_ADMIN:
                    return adminMenus;
                case USER_ROLE_CUSTOMER:
                    return customerMenus;
                case USER_ROLE_DELIVERER:
    ...
    created() {
        ...
        this.$store.dispatch('fetchRestaurants').catch(()=>{});
        this.$store.dispatch('productList/fetchItems').catch(()=>{});
        this.$store.dispatch('orderList/fetchList').catch(()=>{});
        this.$store.dispatch('eCommerce/fetchCart').catch(()=>{});
    },
    beforeDestroy() {
