...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!--====== Line Icons CSS ======-->
        <link rel="stylesheet" href="{{asset('assets/home/css/line-icons.css')}}">
        ...
        <!--====== Font Awesome ======-->
        <link rel="stylesheet" href="{{asset('assets/home/css/all.css')}}" />
    </head>
    <body class="antialiased">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <div class="footer-support text-center">
                            <span class="number">+1 914-677-2023</span>
                            <span class="mail">ceo@luthorr.org</span>
                        </div>
                        <!--  copyright -->
                        <div class="copyright text-center mt-35">
                            <p class="text">46 gramatan avenue, Mount Vernon, NY 10550</p>
                        </div>
                        <div class="copyright text-center mt-35">
                            <p class="text">© 2021 LUTHORR LLC, All rights reserved, designed by KAOTECH LLC, www.Kaotech.org</p>
                        </div>
                    </div>
                </div>
                <!-- row -->
        ...
        <script src="{{asset('assets/home/js/vendor/modernizr-3.7.1.min.js')}}"></script>
        ...
        <!--====== Ajax Contact js ======-->
        <script src="{{asset('assets/home/js/ajax-contact.js')}}"></script>
        ...
        <script src="{{asset('assets/home/js/scrolling-nav.js')}}"></script>
